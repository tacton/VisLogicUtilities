...
| nameResolveFunction   | Function   | undefined            | Optional. Function that can transform the name of the selected asset before it is printed to the console. This function has 1 argument: the string name of the asset that was clicked. |
